...
$(document).ready(function () {
    ...
    $(".editU").click(function () {
        ...
        $("#editEmployeeModal input[name='id_secretaryEditar']").val(id);
        ...
        $("#editEmployeeModal select[name='zoneSecretaryEdit']").val(zone);
        $("#editEmployeeModal input[name='id_secretaryEditM']").val(idS);
    });
    ...
    $(".deleteU").click(function () {
        ...
        $("#deleteEmployeeModal input[name='id_secretaryEliminar']").val(idS);
    });
